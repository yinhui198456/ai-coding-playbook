...
<div class="kb-write" data-kb-file="foundations/github-actions.md">
  <a class="kb-write-btn" href="https://github.com/yinhui198456/ai-coding-playbook/edit/v5/content/foundations/github-actions.md" style="display:inline-block;margin:4px 0 8px;padding:8px 14px;border:2px solid #d29922;border-radius:8px;font-weight:700;cursor:pointer">✍️ 在本机直接填写（免登录）</a>
</div>
