...
| 站 | 干什么 | 谁负责 | 我踩过的坑 |
| --- | --- | --- | --- |
| 1 想清楚需求 | 画出用户从哪来、点什么、看到什么、失败怎么办 | **我** | [[AC-001-user-flow-first\|AC-001]]：跳过这站，AI 替我乱选默认值 |
...
| 5 自动测试 | 跑测试证明每条规则成立 | AI 写、AI 跑 | [[AC-002-test-vs-real-use\|AC-002]]：测试过 ≠ 能用 |
| 6 Review | 检查逻辑、旧入口、漏网路径 | 独立审查者 | [[AC-003-stop-patching\|AC-003]]：审查发现了写入者没碰的旧接口 |
